...
def getSymbols(inURL):
    ...
    for x in range(len(symbs)):
        ...
        if stockCounter % 20 == 0:
            c = c + 20
            getSymbols('https://finviz.com/screener.ashx?v=111&f=sec_industrialgoods' + '&r=' + str(c))
        
        if stockCounter >= 1000:
            break
...
getSymbols('https://finviz.com/screener.ashx?v=111&f=sec_industrialgoods')
