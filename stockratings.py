...
try:
    ...
    print('\n\nRun stockratings.py with the following arguments:\n"SmallCap" to get the ratings for all stocks with over a $300 Million Market Cap\n"MidCap" for the ratings of all stocks with over a $2 Billion Market Cap\n"S&P500" for the ratings for each stock in the S&P500\n\nExample:\nstockratings.py SmallCap\n\n')
...
def getStockData(sym):
    ...
    page = requests.get('https://finviz.com/quote.ashx?t=' + sym, proxies = {"http": next(proxyPool)})
