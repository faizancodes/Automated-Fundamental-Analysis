    ...
    with tqdm(total = numStocks) as pbar:
        ...
        while pageCounter < numStocks:
            ...
            for row in tableRows:
                ...
                for metric, value in list(allStockData[ticker].items())[5 : -2]:
