...
# Change this variable to represent the location where you want your csv files to save 
path = 'C:\\Users\\faiza\\OneDrive\\Desktop\\StockData\\Sector Data\\'

# Change this variable to represent the location where you want your csv files to save all the symbols for each stock 
symbolsPath = 'C:\\Users\\faiza\\OneDrive\\Desktop\\StockData\\SymbolData\\'
...
for i in range(len(sectors)):
    ...
    print('Gathering data from ' + sectors[i] + '...')
